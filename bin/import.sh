...
sed 's/TESISTRIKE\\/TESISTRIKE/g' public/local/newaccount-20191004.csv > public/local/newaccount-20191004-sed.csv
bin/console import:newaccountv1 public/local/newaccount-20191004-sed.csv
