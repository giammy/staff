...
// src/Command/ImportNewaccountV1.php
...
class ImportNewaccountV1 extends Command
{
    // the name of the command (the part after "bin/console")
    protected static $defaultName = 'import:newaccountv1';
    ...
    protected function configure() {
      $this
        ...
        ->setDescription('Import NewAccount CSV v1.')

        // the full command description shown when running the command with
        // the "--help" option
        ->setHelp('Import NewAccount CSV v1.')
