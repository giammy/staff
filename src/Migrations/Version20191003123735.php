 ...
 */
final class Version20191003123735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__account AS SELECT id, username, name, surname, contact_person, account_is_new, profile, group_name, email_enabled, windows_enabled, linux_enabled, note, created, requested, valid_from, valid_to, it_regulation_accepted, version, internal_note FROM account');
        ...
        $this->addSql('INSERT INTO account (id, username, name, surname, contact_person, account_is_new, profile, group_name, email_enabled, windows_enabled, linux_enabled, note, created, requested, valid_from, valid_to, it_regulation_accepted, version, internal_note) SELECT id, username, name, surname, contact_person, account_is_new, profile, group_name, email_enabled, windows_enabled, linux_enabled, note, created, requested, valid_from, valid_to, it_regulation_accepted, version, internal_note FROM __temp__account');
        $this->addSql('DROP TABLE __temp__account');
        $this->addSql('CREATE TEMPORARY TABLE __temp__staff AS SELECT id, username, email, secondary_email, name, surname, group_name, leader_of_group, qualification, organization, total_hours_per_year, total_contractual_hours_per_year, parttime_percent, is_time_sheet_enabled, version, note, office_phone, office_mobile, office_location, created, valid_from, valid_to FROM staff');
        $this->addSql('DROP TABLE staff');
        $this->addSql('CREATE TABLE staff (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username CLOB DEFAULT NULL COLLATE BINARY, email CLOB DEFAULT NULL COLLATE BINARY, secondary_email CLOB DEFAULT NULL COLLATE BINARY, name CLOB NOT NULL COLLATE BINARY, surname CLOB NOT NULL COLLATE BINARY, group_name CLOB DEFAULT NULL COLLATE BINARY, leader_of_group CLOB DEFAULT NULL COLLATE BINARY, qualification CLOB DEFAULT NULL COLLATE BINARY, organization CLOB DEFAULT NULL COLLATE BINARY, total_hours_per_year INTEGER DEFAULT NULL, total_contractual_hours_per_year INTEGER DEFAULT NULL, parttime_percent DOUBLE PRECISION DEFAULT NULL, is_time_sheet_enabled BOOLEAN NOT NULL, version CLOB NOT NULL COLLATE BINARY, note CLOB DEFAULT NULL COLLATE BINARY, office_phone VARCHAR(255) DEFAULT NULL COLLATE BINARY, office_mobile VARCHAR(255) DEFAULT NULL COLLATE BINARY, office_location VARCHAR(255) DEFAULT NULL COLLATE BINARY, created DATETIME NOT NULL, valid_from DATETIME NOT NULL, valid_to DATETIME NOT NULL, internal_note VARCHAR(1024) DEFAULT NULL, last_change_author VARCHAR(255) NOT NULL, last_change_date DATETIME NOT NULL)');
        $this->addSql('INSERT INTO staff (id, username, email, secondary_email, name, surname, group_name, leader_of_group, qualification, organization, total_hours_per_year, total_contractual_hours_per_year, parttime_percent, is_time_sheet_enabled, version, note, office_phone, office_mobile, office_location, created, valid_from, valid_to) SELECT id, username, email, secondary_email, name, surname, group_name, leader_of_group, qualification, organization, total_hours_per_year, total_contractual_hours_per_year, parttime_percent, is_time_sheet_enabled, version, note, office_phone, office_mobile, office_location, created, valid_from, valid_to FROM __temp__staff');
