 ...
 */
final class Version20200929135337 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__staff AS SELECT id, username, email, secondary_email, name, surname, group_name, leader_of_group, qualification, organization, total_hours_per_year, total_contractual_hours_per_year, parttime_percent, is_time_sheet_enabled, version, note, office_phone, office_mobile, office_location, internal_note, last_change_author, created, valid_from, valid_to, last_change_date, description_list, attach_list FROM staff');
        ...
        $this->addSql('INSERT INTO staff (id, username, email, secondary_email, name, surname, group_name, leader_of_group, qualification, organization, total_hours_per_year, total_contractual_hours_per_year, parttime_percent, is_time_sheet_enabled, version, note, office_phone, office_mobile, office_location, internal_note, last_change_author, created, valid_from, valid_to, last_change_date, description_list, attach_list) SELECT id, username, email, secondary_email, name, surname, group_name, leader_of_group, qualification, organization, total_hours_per_year, total_contractual_hours_per_year, parttime_percent, is_time_sheet_enabled, version, note, office_phone, office_mobile, office_location, internal_note, last_change_author, created, valid_from, valid_to, last_change_date, description_list, attach_list FROM __temp__staff');
